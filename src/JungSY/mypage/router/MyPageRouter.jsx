...
import MyBenefits from "../../../ParkES/mypage/MyBenefits.jsx";
import MyInfoTaps from "../../../ParkES/mypage/MyInfoTaps.jsx";
    ...
    return (
        <>
            ...
            <Routes>
                ...
                <Route path={'mybenefit'} element={<MyBenefits />} />
                <Route path={'myinfo'} element={<MyInfoTaps />} />
            </Routes>
